...
class ProbyDetailsPacjent extends StatefulWidget {
  @override
  _ProbyDetailsPacjentState createState() => _ProbyDetailsPacjentState();
}

class _ProbyDetailsPacjentState extends State<ProbyDetailsPacjent> {
  Map proby = {};
