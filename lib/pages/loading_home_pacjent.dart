...
class LoadingHomePacjent extends StatefulWidget {
  @override
  _LoadingHomePacjentState createState() => _LoadingHomePacjentState();
}

class _LoadingHomePacjentState extends State<LoadingHomePacjent> {
  ...
  void startRequest(PacjentRequest pacjentReq) async {
    await pacjentReq.getPacjent(0);
    if (pacjentReq.status == 200) {
      Navigator.pushNamed(context, '/homepacjent', arguments: pacjentReq.ret);
