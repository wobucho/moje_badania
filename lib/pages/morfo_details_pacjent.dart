...
class MorfoDetailsPacjent extends StatefulWidget {
  @override
  _MorfoDetailsPacjentState createState() => _MorfoDetailsPacjentState();
}

class _MorfoDetailsPacjentState extends State<MorfoDetailsPacjent> {
  Map morfo = {};
