...
class MorfoDetailsDiagnosta extends StatefulWidget {
  @override
  _MorfoDetailsDiagnostaState createState() => _MorfoDetailsDiagnostaState();
}

class _MorfoDetailsDiagnostaState extends State<MorfoDetailsDiagnosta> {
  Map morfo = {};
