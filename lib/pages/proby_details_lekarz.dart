...
class ProbyDetailsLekarz extends StatefulWidget {
  @override
  _ProbyDetailsLekarzState createState() => _ProbyDetailsLekarzState();
}

class _ProbyDetailsLekarzState extends State<ProbyDetailsLekarz> {
  Map proby = {};
