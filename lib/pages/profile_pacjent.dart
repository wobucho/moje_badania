...
class ProfilePacjent extends StatefulWidget {
  @override
  _ProfilePacjentState createState() => _ProfilePacjentState();
}

class _ProfilePacjentState extends State<ProfilePacjent> {
  Map profile = {};
